        ...
        <div className="flex-1 overflow-y-auto p-6 md:p-8">
          ...
          {activeTab === 'gmail' && (
            <div className="max-w-4xl mx-auto space-y-6">
              <div className="bg-[#111114] border border-white/5 rounded-3xl p-8 shadow-2xl text-center">
                <Mail className="w-12 h-12 text-red-400 mx-auto mb-4" />
                <h3 className="text-xl font-bold text-white mb-2">Integracja Gmail</h3>
                <p className="text-slate-400 text-sm mb-6">Połącz swoje konto Google aby zarządzać wiadomościami bezpośrednio z panelu.</p>
                <button
                  onClick={async () => {
                    try {
                  ...
                  className="px-6 py-3 bg-red-600 hover:bg-red-500 text-white font-bold rounded-xl text-sm transition-colors shadow-lg shadow-red-600/20"
                >
